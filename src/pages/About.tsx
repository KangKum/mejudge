...
const About = () => {
  return (
    <div
      className="w-full h-full mx-auto px-6 py-16 overflow-y-auto overscroll-contain touch-pan-y"
    ...
    >
      ...
      <h1
        className="md:w-[50%] mx-auto text-3xl font-bold mb-6 text-center"
        style={{ fontFamily: 'var(--font-heading)', color: 'var(--text-emphasis)' }}
      >
        판결문을 읽고 형량을 판단하는 서비스, 나의 판결
      </h1>

      <p className="w-[90%] md:w-[43%] mx-auto mb-8" style={{ lineHeight: '1.75', color: 'var(--text-primary)' }}>
      ...
      <h2
        className="w-[90%] md:w-[43%] mx-auto text-xl font-semibold mb-3"
      ...
      <p className="w-[90%] md:w-[43%] mx-auto mb-20" style={{ lineHeight: '1.75', color: 'var(--text-primary)' }}>

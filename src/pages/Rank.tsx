    ...
    <div className="md:w-[40%] w-[85%] flex flex-col mx-auto items-center">
      ...
      <div className="w-full h-full flex flex-col justify-center items-center">
        ...
        <div className="flex w-full h-12 justify-center items-center gap-1">
          <div className="w-[15%] h-full flex justify-center items-center md:text-xl text-lg border-b">순위</div>
          <div className="w-[60%] h-full flex justify-center items-center md:text-xl text-lg border-b">닉네임</div>
          <div className="w-[25%] h-full flex justify-center items-center md:text-xl text-lg border-b">
            <FaThumbsUp />
          </div>
        </div>
        {loading ? (
          ...
          <div className="w-full overflow-y-auto overflow-x-hidden">
            {rankings.map((user, index) => (
              <div key={index} className="flex w-full h-10 justify-center items-center">
                <div className="w-[15%] h-full flex justify-center items-center">{index + 1}위</div>

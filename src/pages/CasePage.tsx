...
const CasePage = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center overscroll-none">
      <div className="w-[90%] md:w-[55%] flex flex-col overflow-y-scroll overscroll-none">
